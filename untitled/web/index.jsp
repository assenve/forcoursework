...
<div class="container">
    ...
    <form action="${pageContext.request.contextPath}/login" method="post">
        ...
        <div class="form-group">
            ...
            <label class="checkbox-label" for="customer">我是顾客</label>
            <input type="radio" name="role" id="merchant" value="merchant">
            <label class="checkbox-label" for="merchant">我是商家</label>
        </div>

        <div class="form-group">
            <input type="checkbox" name="flag" value="1" id="remember">
            <label class="checkbox-label" for="remember">十天内自动登录</label>
        </div>
    ...
    <a href="${pageContext.request.contextPath}/register.jsp" class="register-link">新用户注册</a>
